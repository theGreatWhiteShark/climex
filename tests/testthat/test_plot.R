...
x.block.fit <- climex::fit.gev( climex::block( climex::anomalies( temp.potsdam ) ) )
x.thresh.fit <- climex::fit.gpd( climex::threshold( temp.potsdam, threshold = 29,
                                                   decluster = TRUE ),
                                threshold = 29, total.length = length( temp.potsdam ) )
